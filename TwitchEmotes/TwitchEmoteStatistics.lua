...
function TwitchStatsSentScrollBar_Update()
	...
	for line=1, nrOfItemsVisible do
	  ...
	  if lineplusoffset <= #filteredStatKeys then
		...
		_G["TwitchStatsSentEntry"..line]:SetText("|cFFfce703" .. lineplusoffset ..".|r ".. texturestr .." " .. " |cFF00FF00"..cEmote.."|r sent: " .. TwitchEmoteStatistics[cEmote][2] .. "x");
		_G["TwitchStatsSentEntry"..line]:Show();
		
	  else
		_G["TwitchStatsSentEntry"..line]:Hide();
	  end
	end
end
...
function TwitchStatsRecievedScrollBar_Update()
	...
	for line=1, nrOfItemsVisible do
	  ...
	  if lineplusoffset <= #filteredStatKeys then
		...
		_G["TwitchStatsRecievedEntry"..line]:SetText("|cFFfce703" .. lineplusoffset ..".|r ".. texturestr .." " .. " |cFF00FF00"..cEmote.."|r seen: " .. TwitchEmoteStatistics[cEmote][3] .. "x");
		_G["TwitchStatsRecievedEntry"..line]:Show();
		
	  else
		_G["TwitchStatsRecievedEntry"..line]:Hide();
	  end
	end
end